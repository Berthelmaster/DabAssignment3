...
namespace SocialNetworkApplication
{
    public class DummyData
    {
        ...
        static async void PostDummy(IMongoCollection<User> post)
        {
        ...
        static async void CircleDummy(IMongoCollection<User> circle)
        {
        ...
        static async void CommentDummy(IMongoCollection<User> comment)
        {
